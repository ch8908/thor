...
- (NSUInteger) zoomLevel
{
    ...
    NSUInteger zoomLevel = 20 - [NSNumber numberWithDouble:zoomExponent].unsignedIntegerValue;
    return zoomLevel;
}
                    ...
                    animated:(BOOL) animated
{
    ...
    MKCoordinateSpan span = [self coordinateSpanWithMapView:self centerCoordinate:centerCoordinate
